...
#include "MGCPlayerControlsComponent.generated.h"
 ...
 *
 * If your Pawn is dealing with Abilities, use MGCAbilityInputBindingComponent instead.
 */
UCLASS(ClassGroup="ModularGASCompanion", Category = "Input", meta = (BlueprintSpawnableComponent))
class MODULARGASCOMPANION_API UMGCPlayerControlsComponent : public UPawnComponent
{
	GENERATED_BODY()
public:
