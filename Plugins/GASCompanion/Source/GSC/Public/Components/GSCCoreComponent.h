...
/**
 * This Actor Component provides abstraction towards Ability System Component and allow definition of Granted Abilities / AttributeSets / Effects
 * regardless of Ability System Component living on Pawn directly or on PlayerStates.
 *
 ...
 *
 * It also provides commonly shared functionality and API for all Actors that have an Ability System Component (again abstracting away Owner / Avatar actor setup for ASC)
 */
...
public:
	 ...
	 *
	 * - Deprecated: Startup Abilities, Attributes and Effects are being deprecated and redundant with
	 * new MGCAbilitySystemComponent which includes support for granting those.
	 *
	 * - If you are using the new Modular Actors introduced with 3.0.0 for 4.27, make sure to use the
	 * Ability System Component available on those actors to grant Abilities, Attributes and Effects
	 * and ignore this section.
	 */
	UPROPERTY(BlueprintReadOnly, EditAnywhere, Category = "GAS Companion|Abilities (Deprecated)")
	...
	// UE_DEPRECATED(4.27, TEXT("This method of initializing Ability System is being deprecated. Use UMGCAbilitySystemComponent instead."))
