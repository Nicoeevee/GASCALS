...
#include "GSCDefaultPawn.generated.h"
...
/**
 * Specialized DefaultPawn class with ASC / AttributeSets setup
 *
 * Blueprint should inherit from this
 */
UCLASS()
class GASCOMPANION_API AGSCDefaultPawn : public ADefaultPawn, public IAbilitySystemInterface, public IGSCCompanionInterface
{
	GENERATED_BODY()
