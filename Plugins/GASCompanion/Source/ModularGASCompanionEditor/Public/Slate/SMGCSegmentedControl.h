...
/**
 * 4.27 - Backported from ue5 source
 *
...
class SMGCSegmentedControl : public SCompoundWidget
{
...
public:
	...
	friend class SMGCSegmentedControl<SlotOptionType>;
	...
	SLATE_BEGIN_ARGS(SMGCSegmentedControl<OptionType>)
	: _Style(&FMGCEditorStyle::Get().GetWidgetStyle<FMGCSegmentedControlStyle>("SegmentedControl"))
	{}
		...
		SLATE_STYLE_ARGUMENT(FMGCSegmentedControlStyle, Style)
	...
	void RebuildChildren()
	{
		...
		for ( int32 SlotIndex = 0; SlotIndex < NumSlots; ++SlotIndex )
		{
			...
			[
				...
				.IsChecked(this, &SMGCSegmentedControl::IsCurrentValue, ChildValue)
				.OnCheckStateChanged(this, &SMGCSegmentedControl::CommitValue, ChildValue)
...
protected:
	...
	const FMGCSegmentedControlStyle* Style;
};
